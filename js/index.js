{
	const dataMusic = [
		...
		{ id: '7029192878', artist: 'Zivert', track: 'WAKE UP!', poster: 'img/7029192878.jpg', mp3: 'mp3/7029192878.mp3' },
		{ id: '6551053494', artist: 'Madonna', track: 'Frozen', poster: 'img/6551053494.jpg', mp3: 'mp3/6551053494.mp3' },
		{
			id: '8458449651',
			artist: 'Trippy Music',
		...
		{ id: '3820960149', artist: 'RSAC', track: 'NBA', poster: 'img/3820960149.jpg', mp3: 'mp3/3820960149.mp3' },
		{
			id: '4391068272',
			artist: 'Minelli',
			track: 'Rampampam',
		...
		{ id: '0807225230', artist: 'Mary Gu', track: 'Косички', poster: 'img/0807225230.jpg', mp3: 'mp3/0807225230.mp3' },
		{
			id: '7456829066',
			artist: 'Adele',
		...
		{ id: '3959251175', artist: 'Adele', track: 'Hello', poster: 'img/3959251175.jpg', mp3: 'mp3/3959251175.mp3' },
		{
			id: '8646210713',
			artist: 'Drake',
		...
		{ id: '5987614638', artist: 'Дора', track: 'Втюрилась', poster: 'img/5987614638.jpg', mp3: 'mp3/5987614638.mp3' },
		{
			id: '0851929096',
		...
		{ id: '9238045504', artist: 'Fousheé', track: 'Deep End', poster: 'img/9238045504.jpg', mp3: 'mp3/9238045504.mp3' },
		{
			id: '6432817901',
			artist: 'Макс Корж',
			track: 'Это наш путь',
		...
		{ id: '7780715415', artist: 'Markul', track: 'Стрелы', poster: 'img/7780715415.jpg', mp3: 'mp3/7780715415.mp3' },
		{
			id: '9736629074',
			artist: 'HENSY',
		...
		{ id: '4157048810', artist: 'Tove Lo', track: 'How Long', poster: 'img/4157048810.jpg', mp3: 'mp3/4157048810.mp3' },
		{
			id: '7435198574',
			artist: 'Imagine Dragons',
			track: 'Natural',
  ...
  `
    ...
    stopBtn.addEventListener('click', () => {
      ...
      const filter = playList.filter(({ artist, track }) => {
				return artist.toLowerCase().includes(value) || track.toLowerCase().includes(value)
			})
